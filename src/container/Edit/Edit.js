...
export default class EditProfile extends Component {
    ...
    upload = (type) => {
        ...
        files.addEventListener('change', e => {
            const storageRef = firebase.storage().ref('/' + this.state.userData.username)
            ...
            uploadTask.on(firebase.storage.TaskEvent.STATE_CHANGED, (snapshot) => {
                ...
                var progressMessage = 'Upload is ' + Math.floor(progress) + '% uploaded. (' + (snapshot.totalBytes / 1000000).toFixed(2) + ' mb) '
                ...
                <div style={{ marginTop: "8rem" }} className={'col-12 bg-light  ' + classes.coperate}>
                    ...
                    {this.state.loading ? null : <React.Fragment >
                        <div className={'row no-gutters mb-2 bg-white'}>
                            ...
                            <div className={'col-8'}>
                                <h4 className="h5 font-weight-light">Username</h4>
                        ...
                        <div className={'row no-gutters mb-2 bg-white'}>
                            ...
                            <div className={'col-8'}>
                                <h4 className="h5 font-weight-light">Phone number</h4>
                                <h4 className="">{this.state.userData.phoneNumber ? this.state.userData.phoneNumber : " + Add phone number"}</h4>
                            </div>
                            <div className={'col-2 text-center text-secondary'}>
                                <i className={"material-icons md-36"}>edit</i>
                            </div>
                        ...
                        <div className={'row no-gutters mb-2 bg-white'}>
                            ...
                            <div className={'col-8'}>
                                <h4 className="h5 font-weight-light">Home address</h4>
                                <h4>{this.state.userData.address ? this.state.userData.address : " + Add home address"}</h4>
                            </div>
                            <div className={'col-2 text-center text-secondary'}>
                                <i className={"material-icons md-36"}>edit</i>
                            </div>
                        ...
                        <div className={'row no-gutters mb-2 bg-white'}>
                            ...
                            <div className={'col-8'}>
                                <h4 className="h5 font-weight-light">Gender</h4>
                                <h4>{this.state.userData.gender ? this.state.userData.gender : "Not set"}</h4>
                            </div>
                            <div className={'col-2 text-center text-secondary'}>
                                <i className={"material-icons md-36"}>edit</i>
                            </div>
                        ...
                        <div className={'row no-gutters mb-2 bg-white'}>
                            ...
                            <div className={'col-8'}>
                                <h4 className="h5 font-weight-light">Date of birth</h4>
                                <h4>{this.state.userData.birthday ? this.state.userData.birthday : "Not set"}</h4>
                            </div>
                            <div className={'col-2 text-center text-secondary'}>
                                <i className={"material-icons md-36"}>edit</i>
                            </div>
